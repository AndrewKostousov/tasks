...
namespace SimQLTask
{
    ...
    public class SimQLProgram_Should
    {
        ...
        public void SumEmptyDataToZero()
        {
            ...
            Assert.AreEqual(new[] {"data.item.cost = 0", "data.itemsCount = 0"}, results);
        }
        ...
        public void SumSingleItem()
        {
            ...
            Assert.AreEqual(new[] {"data.itemsCount = 42"}, results);
        }

        [Test]
        public void Test()
        {
            var s = "{\"data\":{\"a\":{\"x\":3.14,\"b\":{\"c\":15},\"c\":{\"c\":9}},\"z\":42},\"queries\":[\"data.a.x\",\"data.a.b.c\",\"data.a.c.c\",\"data.z\"]}";
